    ...
    <section className="container-narrow relative flex flex-col items-start pt-12 sm:pt-16 text-left">
      ...
      <div className="mt-8 flex w-full max-w-xl flex-col gap-3 sm:flex-row">
        ...
        <a
          ...
          className="inline-flex h-20 flex-1 sm:h-14 items-center justify-center gap-2 whitespace-nowrap rounded-2xl bg-gradient-to-b from-[#333941] to-[#15171a] px-6 text-lg font-semibold text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.2),0_10px_20px_-8px_rgba(0,0,0,0.6)] ring-1 ring-black/10 transition-transform hover:scale-[1.02] active:scale-[0.98]"
        >
